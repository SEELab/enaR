...
\Abstract{ Ecosystem Network Analysis (ENA) provides a framework for
  ...
  ENA community. We a detailed description of how to use the primary
  functions of the package for the analysis of single models or
...
transfers of energy or matter. Constructing these models is
no small task \cite{fathCITE}; however, the system level, macroscopic
analysis that ENA provides can reveal important and often surprising
unsights into the behavior of complex systems \cite{pattenCITE}.
