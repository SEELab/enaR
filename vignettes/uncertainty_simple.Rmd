...
```{r uncertsimp4, eval = T, fig.alt = "Histograms of Boundary Input and Total System Throughflow"}
...
```{r uncertsimp6, eval = T, fig.alt = "Barplot of Uncertainty Analysis Results with 95\\% CI Error Bars"}
opar <- par(las = 1)
